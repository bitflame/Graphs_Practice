...
print("Test 2  - Build Tree Preorder/Inorder expected:[8, 3, 1, 6, 4, 7, 10, 14, 13], actual: ", s.print_tree(res))
preorder = [3, 9, 20, 15, 7]
inorder = [9, 3, 15, 20, 7]
res = s.buildTree(preorder, inorder)
print("Test 3  - Build Tree Preorder/Inorder expected:[3,9,20,15,7], actual: ", s.print_tree(res))
